      ...
      <div className="reg-bg-responsive">
        <div className="reg-card-responsive">
          ...
          <div className="reg-illustration-col">
            ...
            <p className="reg-desc">Join CabApp and start booking or managing rides today.</p>
          </div>
          {/* Registration Form */}
          <div className="reg-form-col">
            <div className="reg-form-inner">
              <h3 className="reg-form-heading">Register</h3>
              {/* Role Switcher */}
              ...
              <form onSubmit={handleRegister} autoComplete="off">
                ...
                <button type="submit" className="btn btn-primary w-100 mb-2 reg-btn-responsive">Register as {role === 'user' ? 'User' : 'Company'}</button>
              </form>
              <div className="text-center mt-3" style={{fontSize:'0.98rem'}}>
                Already have an account?{' '}
                <a href="/login" style={{color:'#2b7cff', textDecoration:'underline', fontWeight:600}}>Login</a>
              </div>
            </div>
          </div>
        </div>
